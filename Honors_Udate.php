...
if(isset($_POST['submit']))
{
	...
	//echo "%%%%%%%%%%%".$contact;
		...
		$update_qur="update registration SET honors='$honors',courses='$courses' where username='$username'";
...
<section class="container">
			<!--update form start-->
			    <form method="post" action="Honors_Update.php">
			    <div class="box effect8">
				    <div id="head">
					<br>
					<h3><u>Honors and Awards</u></h3>
					</div>
				 	<label>Honors/Awards : </label><input type="text" name="honors" value="<?php echo $row['courses']?>"/>
					<hr>
					<label>Courses : </label><input type="text" name="courses" value="<?php echo $row['courses'] ?>"/>
					<hr>
					<br><br>
