...
if(isset($_POST['submit']))
{
	...
	mysql_select_db($dbname,$connection);
		$update_qur="update registration SET companies='$companies',experience='$experience' where username='$username'";
...
<section class="container">
			<!--update form start-->
			    <form method="post" action="Past_Status_Update.php">
			    <div class="box effect8">
				    <div id="head">
					<h3><u>Past Status</u></h3>
					</div>
					<br>
				 	<label>Companies : </label><input type="text" name="companies" value="<?php echo $row['companies']?>"/>
					<hr>
					<label>Experience : </label><input type="text" name="experience" value="<?php echo $row['experience'] ?>"/>
					<hr>
					<br><br>
