...
if(isset($_POST['submit']))
{
	...
	//echo "%%%%%%%%%%%".$contact;
	mysql_select_db($dbname,$connection);
	$update_qur="update registration SET emailid='$email',contactnumber='$contact' where username='$username'";
...
<section class="container">
			<!--update form start-->
			    <form method="post" action="Contact_Details_Update.php">
			    <div class="box effect8">
				    <div id="head">
					<h3><u>Contact Details Update</u></h3>
					</div>
					<br>
					<label>Email ID : </label><input type="text" name="email" value="<?php echo $row['emailid'] ?>"/>
					<hr>
					<label>Contact Number : </label><input type="text" name="contact" value="<?php echo $row['contactnumber'] ?>"/>
					<br><br>
