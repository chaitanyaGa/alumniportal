...
if(isset($_POST['submit']))
{
	...
	//echo "%%%%%%%%%%%".$contact;
	mysql_select_db($dbname,$connection);
	$update_qur="update registration SET presentaddress='$present',permanantaddress='$permanant' where username='$username'";
...
<section class="container">
			<!--update form start-->
			    <form method="post" action="Address_Details_Update.php">
			    <div class="box effect8">
				    <div id="head">
					<h3><u>Address Details Update</u></h3>
					</div>
					<br>
					<label>Present Address : </label><input type="text" name="present" value="<?php echo $row['presentaddress'] ?>"/>
					<hr>
					<label>Permanant Address : </label><input type="text" name="permanant" value="<?php echo $row['permanantaddress'] ?>"/>
					<br><br>
