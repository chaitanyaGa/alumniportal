...
if(isset($_POST['submit']))
{
	...
	mysql_select_db($dbname,$connection);
	$update_qur="update registration SET name='$name',dob='$dob',languages='$languages' where username='$username'";
...
<section class="container">
			<!--update form start-->
			    <form method="post" action="Personal_Details_Update.php">
			    <div class="box effect8">
					...
					<hr>	
					<label>Date of birth : </label><input type="text" name="dob" value="<?php echo $row['dob']; ?>"/>
					<hr>
					<label>Languages Known : </label><input type="text" name="languages" value="<?php echo $row['dob'];?>"/>
					<br><br>
