...
if(isset($_POST['submit']))
{
	...
	if(mysql_select_db($dbname,$connection))
	{
		...
		if(in_array($_FILES['blogcover']['type'],$types))
		{
			...
			$qur="insert into newblogtable1(id,username,title,content,date,time,cover,category) values('','$username','$title','$description','$date','$time','$url','$category')";
			...
			//Failure while inserting data
				...
				{
					echo "<script>";
					echo "alert('There isfwgrgrgrgrw while creating a blog please try again .')";
					echo "</script>";
				}
