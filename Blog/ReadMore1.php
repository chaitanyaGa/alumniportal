...
if(isset($_POST['like']))
{
	$old_likes="select * from blogs where blogcover='".$cover."'";
	...
	$new_likes="update blogs SET likes='".$old_cnt."' where blogcover='".$cover."'";
		...
		<div class="container">
			...
			<form action="ReadMore.php" method="post">
				...
				<div class="hidden" id="comment">
					...
					<input type="hidden" name="cover" value="<?php echo $row['blogcover'];?>"/> 
