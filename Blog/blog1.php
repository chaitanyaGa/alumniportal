...
<?php
	...
	<div class="card">
		...
		<img src="<?php echo $row1['cover'];?>" style="width:100%;height:350px">
		...
		<?php $str=base64_decode($row1['content']);?>
		  ...
		  <form action="ReadMore.php" method="post">
			<div class="row">
			   ...
			   <input type="hidden" id="var"  name="cover" value="<?php echo $row1['cover'] ?>"	/>
