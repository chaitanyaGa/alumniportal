...
if(isset($_POST['submit']))
{
	...
	mysql_select_db($dbname,$connection);
	if(!(empty($password1)))
		$update_qur="update registration SET password='$password1' where username='$username'";
...
<section class="container">
			<!--update form start-->
			    ...
			    <div class="box effect8">
				    <div id="head">
					<h3><u>Login Details Update</u></h3>
					</div>
					<br>
					
					<label>Old Password : </label><h5><?php echo $row['password'] ?><h5/>
					<hr>
					<label>New Password :</label><input type="text" name="password_new"/>
					<hr>
					<br><br>
