...
if(isset($_POST['submit']))
{
	...
	mysql_select_db($dbname,$connection);
		...
		$update_qur="update registration SET state='$state',city='$city' where username='$username'";
...
<section class="container">
			<!--update form start-->
			    <form method="post" action="Present_Location_Update.php">
			    <div class="box effect8">
				    <div id="head">
					<h3><u>Present Location Update</u></h3>
					</div>
					<br>
				 	<label>State : </label><input type="text" name="state" value="<?php echo $row['state'] ?>"/>
					<hr>
