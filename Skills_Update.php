...
if(isset($_POST['submit']))
{
	...
	$update_qur="update registration SET softwareknowledge='$soft',other='$other',computer_languages='$computer_languages' where username='$username'";
...
<section class="container">
			<!--update form start-->
			    <form method="post" action="Skills_Update.php">
			    <div class="box effect8">
				    <div id="head">
					<h3><u>Skills Update</u></h3>
					</div>
					<br>
				 	<label>Software Knowledge : </label><input type="text" name="soft" value="<?php echo $row['softwareknowledge']?>"/>
					<hr>
					<label>Computer Languages : </label><input type="text" name="computer_languages" value="<?php echo $row['computer_languages']?>"/>
					<hr>
					<label>Other : </label><input type="text" name="other" value="<?php echo $row['other'] ?>"/>
					<br><br>
